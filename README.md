...
These use a [test-only private GPG key](./src/test/resources) generated by this [script](./src/test/scripts/create-test-signing-key.sh) (run it from the repository root).
